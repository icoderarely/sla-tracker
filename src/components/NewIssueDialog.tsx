...
export default function NewIssueDialog({ clients }: { clients: Client[] }) {
  ...
  return (
    <>
      <button
        type="button"
        onClick={open}
        className="inline-flex items-center gap-1.5 rounded-lg bg-primary-600 hover:bg-primary-700 text-white text-sm font-medium px-3.5 py-2 transition-colors"
      >
